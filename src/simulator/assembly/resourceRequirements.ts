...
const COMMON_REQUIREMENTS: readonly SimulatorResourceRequirement[] = Object.freeze([
  requirement("render.chinese-font", "fonts/chinese", ["chinese.ttf"]),
  ...
  requirement("render.stage", "prefabs/bms/stage", ["stage-light.png", "stage-speaker.png", "stage-speaker-glow.png", "stage-psyllium.png"]),
  requirement("render.result", "prefabs/bms/result", ["result-menu.png", "rhythmBG.png", "result-banner.png", "LoginBonus.png", "Tex_parSet_1.png", "Tex_parSet_2.png"]),
  ...
  requirement("audio.common", "sound/common", [
    "SE_RESULT_SUCCESS.mp3", "SE_RESULT_FAILED.mp3", "SE_RESULT_SCORE_COUNT.mp3", "SE_RHYTHM_CLEAR.mp3", "SE_RHYTHM_FULLCOMBO.mp3", "SE_RHYTHM_GAYA.mp3",
    "SE_RHYTHM_TAP_SKILL.mp3", "bad.mp3", "miss.mp3",
  ]),
  requirement("audio.result", "sound/result", ["after_live.mp3"]),
