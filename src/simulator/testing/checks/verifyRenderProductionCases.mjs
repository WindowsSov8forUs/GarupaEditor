...
const fixtureRoot = resolve(testingRoot, "fixtures/reverse-snapshots");
...
export function verifyRenderObservation(observation, oracle, closure) {
  ...
  const predicates = new Map([
    ...
    ["PR26", () =>
      addScore.hudSpriteNodes?.filter((node) => node.visible === true).length === expectedAdd.spriteCount &&
      addScore.hudText === null],
