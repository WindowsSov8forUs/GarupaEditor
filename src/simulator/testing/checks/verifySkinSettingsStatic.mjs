...
const actualAcceptance = read("testing/cases/rendering/renderPixi.test.ts") +
  read("testing/cases/platform/skinSettings.webview2.test.ts") +
  read("testing/cases/resources/skinProductionComposition.test.ts") +
  read("testing/cases/platform/skinSettings.webview2.mjs");
