...
const suiteManifest = read("testing/suite/manifest.mjs");
if (!suiteManifest.includes('"session.live-rehearsal"') ||
    !suiteManifest.includes('"session.live-rehearsal.static"')) {
  throw new Error("Live/Rehearsal capability cases are absent from the unified suite");
}
