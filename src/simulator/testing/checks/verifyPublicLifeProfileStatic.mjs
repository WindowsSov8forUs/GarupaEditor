...
if (!suiteManifest.includes('"session.public-life-profile"') ||
    !suiteManifest.includes('"session.public-life.static"')) {
  throw new Error("Public Life capability cases are absent from the unified suite");
}
