...
const outputRoot = sharedOutputRoot ?? mkdtempSync(join(tmpdir(), "garupa-c07-evidence-consumption-"));
...
try {
  ...
  run(process.execPath, [
    join(outputRoot, "src", "simulator", "testing", "c07EvidenceConsumption.test.js"),
  ]);
