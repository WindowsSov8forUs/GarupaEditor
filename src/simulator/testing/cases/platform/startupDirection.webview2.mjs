...
try {
  ...
  run(process.execPath, [esbuild, join(testingRoot, "cases/platform/startupDirection.webview2.test.ts"), "--bundle", "--platform=browser", "--format=iife", "--target=chrome120", `--outfile=${bundle}`], repositoryRoot);
  ...
  if (visualDigest !== "5ffd7d40b278888397dd7a2e2e5c0f1d07fdae52965c20e4dedfcedc975f3edc") {
