...
try {
  prepareStage();
  run(process.execPath, [esbuild, join(testingRoot, "cases/platform/originalLiveSettings.webview2.test.ts"), "--bundle", "--platform=browser", "--format=iife", "--target=chrome120", `--outfile=${bundle}`], repositoryRoot);
