...
const outputRoot = sharedOutputRoot ?? mkdtempSync(join(tmpdir(), "garupa-simulator-chart-graphs-"));
...
try {
  ...
  run(process.execPath, [
    join(outputRoot, "src", "simulator", "testing", "cases/chart/chartNoteGraph.test.js"),
  ]);
