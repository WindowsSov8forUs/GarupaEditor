...
import { projectSyncConnectionCount } from "../../expected/independent/chartSyncProjection.mjs";
...
const outputRoot = sharedOutputRoot ?? mkdtempSync(join(tmpdir(), "garupa-chart-production-"));
