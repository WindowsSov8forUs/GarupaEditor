...
import { DEFAULT_PUBLIC_ORIGINAL_LIVE_SETTINGS } from "../../support/session/originalLiveSettingsProfile";
import {
  createDefaultTestSkinSettings,
  createTestPresentationPackage,
} from "../../support/media/startupPresentationProfile";
import {
...
} from "../../support/resources/sharedStaticResourceStore";
import { selectSimulatorStaticResources as selectStaticResourceInternal } from "../../support/resources/staticResourceSelector";
...
} from "../../support/resources/sharedResourceAdapters";
import { CURRENT_AUDIO_TEST_PROFILE } from "../../support/media/audioSessionBgmProfile";
...
import type { SimulatorAssemblyResult } from "../../support/resources/sharedResourceAdapters";
