...
const outputRoot = sharedOutputRoot ?? mkdtempSync(join(tmpdir(), "garupa-manual-timeout-"));
...
try {
  ...
  run(process.execPath, [join(outputRoot, "src", "simulator", "testing", "cases/gameplay/manualTimeoutJudgement.test.js")]);
