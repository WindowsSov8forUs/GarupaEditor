...
} from "../../support/session/originalLiveSettingsProfile";
import { LIVE_AUTO_MODE, LIVE_MANUAL_MODE, REHEARSAL_AUTO_MODE, REHEARSAL_MANUAL_MODE } from "../../support/session/modeFixtures";
...
import { assertHudPixiRenderingEquivalence } from "../../support/rendering/hudPixiAssertions";
...
import { augmentScoreHudProfilesForPause, PAUSE_COUNTDOWN_FIXTURE_RELATIVE_PATHS } from "../../support/session/pauseControlResources";
import { resolveOriginalSkinRecipe } from "../../../engine/skin/originalSkinResolver";
import { selectResolvedSkinResourceInventory } from "../../support/resources/skinResourceSelector";
import { prepareSelectedSkinPortablePacks } from "../../support/resources/skinPortablePack";
import { ImmutableSharedStaticResourceStore } from "../../support/resources/sharedStaticResourceStore";
import { prepareSkinRenderOverlay } from "../../../assembly/skinRenderPreparation";
import { gameClearTestResources } from "../../support/rendering/gameClearResources";
...
async function main(): Promise<void> {
  ...
  console.log("actual Pixi ordinary-visible product regression passed; original Unity/GPU equivalence is not claimed: Note cubic owners + Combo/AP/AddScore/Result/Life resource routes");
}
...
function ordinaryScene() {
  ...
  return Object.freeze({
    ...
    tapLaneEffectPositions: Object.freeze([
      -6.599999904632568, -5.5, -4.400000095367432, -3.299999952316284,
      -2.200000047683716, -1.100000023841858, 0, 1.100000023841858,
      2.200000047683716, 3.299999952316284, 4.400000095367432, 5.5, 6.599999904632568,
    ].map((x) => v3(x, -3.450000047683716, -13.5))),
