...
console.log("ordinary visible evidence contract passed: serialized/portable requirements loaded from Reverse d4ab8146; browser consumption is a separate capability");
