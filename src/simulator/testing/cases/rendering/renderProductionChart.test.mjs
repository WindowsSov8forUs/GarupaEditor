...
async function verifyHabahiroCompleteReplay() {
  ...
  const scene = Object.freeze({
    ...
    tapLaneEffectPositions:Object.freeze([-6.599999904632568,-5.5,-4.400000095367432,-3.299999952316284,-2.200000047683716,-1.100000023841858,0,1.100000023841858,2.200000047683716,3.299999952316284,4.400000095367432,5.5,6.599999904632568].map(x=>v3(x,-3.450000047683716,-13.5))),
...
async function verifyLegacyRejectionAndOrdinaryReplay() {
  ...
  const keyFixture = JSON.parse(readFileSync(join(testingRoot, "support", "resources", "habahiroDegradedSpriteKeys.json"), "utf8"));
  ...
  console.log("render HABAHIRO historical degraded-profile rejection passed before engine creation");
  return;
