import { LIVE_AUTO_MODE } from "../../support/session/modeFixtures";
import { originalLiveSettingsForTest } from "../../support/session/originalLiveSettingsProfile";
...
import { engineInput, noteBatch } from "../../support/session/engineFoundationFixtures";
...
const ORDINARY_NOTE_SCENE = Object.freeze({
  ...
  ].map((x) => vector3(x, -3.450000047683716, -13.5))),
...
async function testSharedTypedHudValidation(): Promise<void> {
  ...
  console.log("ok 10 - shared typed HUD state contract preserves the complete regression vector");
}
