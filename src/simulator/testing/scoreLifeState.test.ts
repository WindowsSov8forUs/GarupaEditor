...
equal(record.getClearStatus(2), 2, "GetClearStatus returns Full Combo for Perfect plus Great");
const allPerfectRecord = new InGameRecord(1000, 1000, 2000);
allPerfectRecord.incrementResult(4, 0); allPerfectRecord.incrementResult(4, 0);
equal(allPerfectRecord.getClearStatus(2), 3, "GetClearStatus returns All Perfect for all Perfect");
equal(allPerfectRecord.getClearStatus(3), 1, "GetClearStatus otherwise returns ordinary clear");
