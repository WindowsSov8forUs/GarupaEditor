...
const outputRoot = sharedOutputRoot ?? mkdtempSync(join(tmpdir(), "garupa-live-rehearsal-tests-"));
...
try {
  ...
  run(process.execPath, [join(outputRoot, "src", "simulator", "testing", "pauseControlScene.test.js")]);
