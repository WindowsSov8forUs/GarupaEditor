...
const manifestSource = read("src/simulator/testing/legacyHabahiroBestdoriManifest.ts");
const providerSource = read("src/simulator/testing/legacyHabahiroBestdoriProvider.ts");
