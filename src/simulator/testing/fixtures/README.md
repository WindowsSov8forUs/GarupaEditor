...
- `reverse-snapshots/score-hud-final-visible/` 包含Reverse `818b8db6`的最终TotalScore UILabel→UIFont1799→sgm Font75链、bitmap score-font拒绝、D/C运行观察、NGUI UISpriteData边框纠错与完整状态验收合同，并只保留一个430×95原作TotalScore观察crop；不复制完整设备帧、trace、ARM64或本地Unity资产。
