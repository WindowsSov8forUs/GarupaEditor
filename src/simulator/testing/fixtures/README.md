...
- `reverse-snapshots/full-visible-lifecycle/` 包含已推送Reverse `4a61a184`的全量再审合同、14,702-event R1 trace及10张最小语义帧：Score编码色与动态Rank公式、SS只在Rank切换触发、Auto/AddScore/Life/Pause、Slide/Lane/default skin00粒子、43对象base clear、25对象Full Combo、36对象All Perfect和104/129曲线clip。原作帧只作补充观察；独立primitive/lifecycle oracle读取结构化合同，不读取Garupa生产helper。
