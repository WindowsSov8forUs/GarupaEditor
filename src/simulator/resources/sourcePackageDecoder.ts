import particleCatalogJson from "../../data/simulator/currentParticleSemanticCatalog.json";
import renderCatalogJson from "../../data/simulator/currentRenderSemanticCatalog.json";
import {
