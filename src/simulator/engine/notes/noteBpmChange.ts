...
export class NoteBpmChange {
  ...
  execUpdate(
    ...
    // Both BMS and Garupa already resolved their target in the common position domain.
    const threshold = noteInformation.absolutePos - 192 * noteInformation.barIndex;
    const reached =
