...
export interface StartupDirectionSceneState {
  ...
  /** Independent CE/RevSubtraction widget RGB; its alpha stays one. */
  readonly stageSubtractionColor: number;
...
export function freezeStartupDirectionSceneState(
  ...
  for (const field of [
    value.informationAlpha, value.hudAlpha, value.darkCoverAlpha, value.stageSubtractionColor,
...
export const INITIAL_STARTUP_DIRECTION_SCENE_STATE = freezeStartupDirectionSceneState({
  ...
  stageSubtractionColor: Math.fround(1),
  stagePhase: "dark",
