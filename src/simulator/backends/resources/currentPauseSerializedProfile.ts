...
const label = (
  ...
  position: Object.freeze(position), size: Object.freeze(size), depth, fontSize, pivot, spacingX, spacingY, maxLines: 0,
});
const button = (
  identity: string,
  position: readonly [number, number],
...
export const CURRENT_PAUSE_SERIALIZED_GRAPHS = Object.freeze({
  retryable: Object.freeze({
    ...
    content: label([0, -14], [900, 114], 10, 24, "center", 6),
  ...
  selectable: Object.freeze({
    ...
    content: label([0, -18], [940, 360], 10, 24, "center", 6),
    buttons: Object.freeze([
      button("cancel", [-136, 232 - 140], "button_gray", [230, 56], 32, 1),
  ...
  annotated: Object.freeze({
    ...
    content: label([5, -50], [534, 56], 10, 23, "center", 2, 1),
    annotation: label([-7, 9], [534, 360], 10, 19, "center", 8, 1),
    buttons: Object.freeze([
