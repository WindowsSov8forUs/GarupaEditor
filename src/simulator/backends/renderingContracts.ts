...
import type { ExponentialTransform, ExponentialLine } from "../engine/rendering/exponentialCoordinates";
...
export type RenderCommand =
  ...
  | (RenderObjectCommandBase & {
      ...
      /** Finite host-space note transform, clipped before GPU vertex upload. */
      readonly unclipped?: { readonly x: number; readonly y: number; readonly scaleX: number; readonly scaleY: number; readonly exponential?: ExponentialTransform };
  ...
  | (RenderObjectCommandBase & {
      ...
      readonly unclipped?: { readonly start: readonly [number, number]; readonly end: readonly [number, number]; readonly width: number; readonly exponential?: ExponentialLine };
