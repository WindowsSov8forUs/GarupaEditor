...
export class PixiRendererBackend implements SimulatorRendererBackend {
  ...
  getStartupDirectionCommonResources(): SimulatorResult<PixiStartupDirectionCommonResources> {
    ...
    if (titleBase === undefined || difficultyBackground === undefined || lineStar === undefined || stageLight === undefined || jacketFrame === undefined || fullLiveLabel === undefined || font === undefined ||
...
function updatePersistentScoreHud(
  ...
  const foregroundMask = findHudDescendant(progress, "score-gauge-foreground-fill-mask") as Graphics | null;
  if (foreground === null || foregroundMask === null) throw new Error("Persistent Score gauge foreground graph is incomplete");
