...
import layout from "../../../data/simulator/stageLightLayout.json";
...
export class PixiStageLights {
  ...
  constructor(texture: Texture, source: typeof layout | { readonly lights: readonly ((typeof layout.lights)[number] & { readonly colorTable: readonly (readonly number[])[] })[] } = layout) {
    ...
    this.lights = source.lights.map((entry) => {
