...
export interface ParticleBundleProfile {
  readonly key: "ordinary" | "directional" | "game-clear" | "result";
...
export type ParticleInstanceIdentity =
  ...
  | {
      ...
      /** Half-button list index uses the same lower integer as the adjacent full button. */
      readonly isHalfButton: boolean;
