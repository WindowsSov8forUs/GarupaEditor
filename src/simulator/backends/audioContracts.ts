...
export interface AudioResultBgmResourceProfile extends AudioResourceProfileBase {
  readonly role: "result-bgm";
  readonly logicalId: "sound/result";
  readonly cue: "after_live";
  readonly identity: "semantic-exact";
  readonly signal: "portable-equivalent-lossy";
}
...
export type AudioCommand =
  | { readonly kind: "bgm.start-result"; readonly cue: "after_live"; readonly fade_seconds: 0.25; }
  | {
  ...
  | {
      ...
      readonly fade_in_bits: "0x3F000000" | "0x00000000";
    }
  | {
      readonly kind: "se.fade-owned-loop";
      readonly owner_key: string;
      readonly target_bits: "0x00000000";
      readonly duration_bits: "0x3FC00000" | "0x00000000";
