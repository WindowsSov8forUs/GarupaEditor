...
| Original Skin settings / switching | `open-evidence-required` | Reverse `31a8ef4e`已授权`closed-static-portable`实现；Schema 11只先冻结original aggregate设置，resolver/resource/backend接线及验收完成前当前能力行仍保持开放；Collabo 36必须包级失败关闭 |
