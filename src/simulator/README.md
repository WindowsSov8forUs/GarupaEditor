...
当前阶段为“资源与Pixi渲染”，任务书见`tmp/simulator-resource-pixi-rendering-task.md`，验收记录见`tmp/simulator-resource-pixi-rendering-acceptance.md`。Reverse `64a88a8821d20eb1cc43003a9bd959c892d40e12`与Garupa 826项冻结包包含R1–R6；final R6为190,401 events、2,492 aggregate frames和26个observed owner。Production除R4/R5授权外新增ScoreUp 1–4、correct BMS button 0..6 lane mapping，以及显式HAB degraded全谱proxy与1728位置flash-start→change-lane disclosure；exact HAB仍不开放。当前矩阵为19 closed/current-subset/degraded、18 partial、3 blocked，从clean pushed `1a9a626`运行14-stage总入口通过，RP13通过但RP14不通过。硬阻断严格为PR14 threshold/material shader、PR30 Guard/NeverDie warning和PR39 ordinary Slide terminal/full chart；AddScore/JudgeTiming/Crescendo text/field setup等partial路线也不得外推。原始HAB UnityFS、natural HAB R1与original frame保持`habahiro_exact_parity_gate=open-not-claimed`。
