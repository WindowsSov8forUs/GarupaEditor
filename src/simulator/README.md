...
| Original Live settings | `closed-portable` | Reverse `aae7e4fe`/`50bc40b6`/`07bf4e7c`：Schema 13 Primary A、Secondary B、SyncLine、NoteColor、VisibleTapLaneEffect、AllPerfectStatusDisplayMode、MvDarkness均有冻结identity和engine/render/movie consumer；旧缓存缺AP选择时要求显式ON/OFF，不迁移fixed-on；Retry/MoveTime/Pause lifecycle、4 PNG/13-slot owner、Actual Pixi和3-fresh WebView2；完整边界见[`original-live-settings-contract.md`](./original-live-settings-contract.md) |
