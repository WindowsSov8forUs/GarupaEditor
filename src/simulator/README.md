...
当前阶段为“资源与Pixi渲染”，任务书见`tmp/simulator-resource-pixi-rendering-task.md`。Reverse `60410ae02f69b9d78cc554717b3dd04b941cd0c2`已关闭`ordinary-exact-habahiro-degraded`交付profile：ordinary natural Live冻结87,364个连续匿名R1事件与7个1600×720实体frame；HAB portable资源锁定12项current external asset与179个Sprite row/hash，必须由host本地提供并显示`Approximate HABAHIRO`。V01、D01–D18与PR01–PR40已按该profile关闭，`rendering_delivery_gate=closed`、`production_authorization=true`，下一批为RP03 typed render/resource contracts。原始HAB UnityFS、natural HAB R1与original frame仍保持`habahiro_exact_parity_gate=open-not-claimed`；禁止静默fallback、production/test联网、资源二进制入库及原作parity宣称。
