...
当前阶段为“资源与Pixi渲染”，任务书见`tmp/simulator-resource-pixi-rendering-task.md`，验收记录见`tmp/simulator-resource-pixi-rendering-acceptance.md`。Reverse `fa28856133e0bc45f355407c39b84cac9cbcfb95`与Garupa 790项冻结包锁定ordinary R1 87,364 events、geometry R2 87,037 events/636 frames、visible HUD R3 19,888 events/631 frames/22 setters、7个1600×720实体frame，以及Long child、projection、resource/HUD/animation profile。Production已实现local hash/preflight资源、Pixi Sprite、22/60 base NoteMesh、ordinary sync textured quad、Normal与Long+Normal tail完整生命周期、explicit polygon mask、visible Score/Combo/Life、Combo/Life owner-local Float32 animation sampling和可见`Approximate HABAHIRO`标签；failure/context/dispose矩阵与14-stage `simulator:test:resource-pixi-rendering`均通过。RP13通过，但production矩阵仍为14 closed、14 partial、12 blocked，RP14不通过：Flick/Directional icon、Slide chain、Multiple side/back-line/reconnect、advanced/threshold、field host scene、完整HUD overlay和production chart replay仍缺新runtime授权。原始HAB UnityFS、natural HAB R1与original frame保持`habahiro_exact_parity_gate=open-not-claimed`；禁止把失败关闭或绿色回归解释为完整阶段/parity，禁止静默fallback、production/test联网与资源二进制入库。
