  ...
  return (
    <div className="command-bar">
      <div className="command-group">
        <button type="button" className="command-text-button" onClick={onImportJson} title="导入">
          <img className="command-text-icon" src={importJsonIcon} alt="" aria-hidden="true" />
          <span className="command-text-label">导入</span>
        </button>
        <button type="button" className="command-text-button" onClick={onExportJson} title="导出">
          <img className="command-text-icon" src={exportJsonIcon} alt="" aria-hidden="true" />
          <span className="command-text-label">导出</span>
        </button>
        <button type="button" className="command-text-button" onClick={onOpenSkinSettings} title="皮肤">
          <img className="command-text-icon" src={skinIcon} alt="" aria-hidden="true" />
          <span className="command-text-label">皮肤</span>
        </button>
      </div>
