...
import resultParticle1Url from "../../assets/game/prefabs/bms/result/Tex_parSet_1.png?url&no-inline";
...
const DEFINITIONS: readonly SimulatorBuiltinResourceDefinition[] = Object.freeze([
  ...
  resource("sound/result", "Result BGM", "package", [
    file("game/sound/result/after_live.mp3", "after_live.mp3", "audio/mpeg", resultBgmUrl),
  ]),
  resource("prefabs/bms/result", "Performance result details", "package", [
    file("game/prefabs/bms/result/result-banner.png", "result-banner.png", "image/png", resultBannerUrl),
    file("game/prefabs/bms/result/LoginBonus.png", "LoginBonus.png", "image/png", resultRankLightUrl),
  ...
  resource("prefabs/bms/stage", "Ordinary stage resources", "image", [
    file("game/prefabs/bms/stage/stage-dark-cover.png", "stage-dark-cover.png", "image/png", stageDarkCoverUrl),
