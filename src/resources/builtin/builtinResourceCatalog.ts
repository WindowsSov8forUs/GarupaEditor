...
import copyActionUrl from "../../assets/icons/copy-action.svg?url&no-inline";
import displayUrl from "../../assets/icons/display.svg?url&no-inline";
import editUrl from "../../assets/icons/edit.svg?url&no-inline";
import imageExportUrl from "../../assets/icons/image-export.svg?url&no-inline";
import jsonExportUrl from "../../assets/icons/json-export.svg?url&no-inline";
import jsonImportUrl from "../../assets/icons/json-import.svg?url&no-inline";
import mirrorActionUrl from "../../assets/icons/mirror-action.svg?url&no-inline";
import optionsTitleUrl from "../../assets/icons/options-title.svg?url&no-inline";
import pasteActionUrl from "../../assets/icons/paste-action.svg?url&no-inline";
import previewUrl from "../../assets/icons/preview.svg?url&no-inline";
import settingsUrl from "../../assets/icons/settings.svg?url&no-inline";
import simulatorPauseUrl from "../../assets/icons/simulator-pause.svg?url&no-inline";
import simulatorPlayUrl from "../../assets/icons/simulator-play.svg?url&no-inline";
import skinUrl from "../../assets/icons/skin.svg?url&no-inline";
import undoActionUrl from "../../assets/icons/undo-action.svg?url&no-inline";
import chartUiPrimaryFontUrl from "../../assets/fonts/TTShinGoM.ttf?url&no-inline";
