...
本目录冻结 Reverse 静态提交 `6c902656c72f3983fb04386038dcfe38f0d53797`、R0输入提交 `1ee976ea1de24cb0567762a74e2d091ae4c78464`、R1子批提交 `72aa279fb07041b04ca649df918fa35ab0490d91`、正判定采集计划提交 `e65f3411d1a91cfa5ecf0d7b29e99605b04e8a41` 与提前输入v2计划提交 `3adf31f987830ce5b82aba0d92813b69fda3cec7`。
...
- v1 220动作计划保留为superseded控制来源且无trace晋升；v2只把输入前等待由7000ms改为500ms，当前标记`committed-plan-not-runtime-evidence`，执行成功前不关闭任何新结论。
...
`verify.mjs` 校验五个Reverse commit、source/copy/index三方字节、manifest、冻结SHA256SUMS、静态contract/findings/closure、BMS/cache record、R1压缩raw trace、正判定计划来源/动作、观察型capture约束和业务门状态。
