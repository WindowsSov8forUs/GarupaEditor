...
`verify.mjs` 校验六个Reverse commit、source/copy/index三方字节、manifest、冻结SHA256SUMS、静态contract/findings/closure、BMS/cache record、R1压缩raw trace、正判定计划来源/动作、观察型capture约束和业务门状态。
