...
- `BS01–BS36` partial oracle: 3 static-confirmed, 20 partial, 13 blocked; `unknown_fields=151`, `blocking_findings=91`.
...
The BS01–BS36 oracle remains fail-closed without pretending closure: BS05, BS06 and BS11 are fully confirmed from direct 10.1.4 static evidence; 20 cases contain only directly supported static/R1/chart-count projections plus explicit unknown fields; 13 cases remain blocked with no expected projection. The production chart-count oracle now supplies the ordinary `979` and HABAHIRO `731` family decompositions to BS01/BS02, removing four chart unknowns and moving BS02 from blocked to partial. The fixed-event oracle still records 151 unknown fields and 91 blocking findings, so D19 and D24 remain required-before-code. Fever transitions, multiple/overlapping Skill, guard/Never Die, deck/start-data/master rows and final `closure.json` remain open. The five ABI-unsafe fields stay unconsumed. The business gate remains open and no trace or partial oracle authorizes production implementation.
