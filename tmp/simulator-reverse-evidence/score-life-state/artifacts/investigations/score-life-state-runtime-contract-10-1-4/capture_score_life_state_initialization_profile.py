#!/usr/bin/env python3
"""Capture a privacy-minimized initialization profile on 10.1.4 ARM64."""
...
def main() -> int:
    ...
    output = {
        ...
        "privacy": {
            ...
            "omitted": ["user_id", "room_id", "room_name", "user_deck_contents", "deck_element_contents", "display_strings"],
        },
