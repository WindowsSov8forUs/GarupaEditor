...
R5 is partial behavioral evidence, not full HUD/field closure. A successful transport/summary gate authorizes only the five true routes in `resource_pixi_rendering_hud_field_r5_profile.json`; Guard, NeverDie, JudgeTiming, AllPerfect, AddScore coroutine, field setup and changeable Skill text remain false. R3 LifeHeal and serialized field/mask boundaries remain separately valid but are not relabeled as R5 observations.
...
py -3.14 artifacts\investigations\resource-pixi-rendering-runtime-contract-10-1-4\build_resource_pixi_rendering_hud_field_r5_targets.py
...
py -3.14 artifacts\investigations\resource-pixi-rendering-runtime-contract-10-1-4\verify_resource_pixi_rendering_hud_field_r5_targets.py
py -3.14 artifacts\investigations\resource-pixi-rendering-runtime-contract-10-1-4\verify_resource_pixi_rendering_hud_field_r5_runtime.py runtime\ordinary-rendering-hud-field-r5-core.trace.json.gz --owner-group core
py -3.14 artifacts\investigations\resource-pixi-rendering-runtime-contract-10-1-4\verify_resource_pixi_rendering_hud_field_r5_profile.py
