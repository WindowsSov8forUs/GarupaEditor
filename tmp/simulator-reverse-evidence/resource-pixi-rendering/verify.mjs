...
const sourceCommit = "60410ae02f69b9d78cc554717b3dd04b941cd0c2";
...
check(manifest.entries.length === 724 && manifest.counts.totalEntries === 724, "Unexpected manifest entry count");
...
check(sums.size === 730, "Unexpected SHA256SUMS count");
...
console.log(`verified resource/Pixi delivery evidence: entries=724 methods=673 layouts=32 enums=19 resources=11026/57/100 profiles=8+4+4+5 plans=55/2/13 HAB=2/12/179 exact=open degraded=authorized H=28 D=18 PR=40 offline=closed delivery=closed exact-HAB=open production=true${validateIndex ? " index=checked" : ""}`);
