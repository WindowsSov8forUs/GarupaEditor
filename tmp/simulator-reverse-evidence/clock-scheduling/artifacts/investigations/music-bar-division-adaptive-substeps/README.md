...
| Bucket | Delta time | Initial steps | Fallback after increment |
| --- | --- | ---: | --- |
| 0 | `< 0.0179999992` | 1 | `counter[0] > 100` |
| 1 | `< 0.0329999998` | 2 | `counter[1] > 20` |
| 2 | `< 0.0500000007` | 3 | `counter[2] >= 6` |
| 3 | otherwise | 4 | no direct comparison |

Consequently the 101st bucket-0 sample, 21st bucket-1 sample, and 6th bucket-2
