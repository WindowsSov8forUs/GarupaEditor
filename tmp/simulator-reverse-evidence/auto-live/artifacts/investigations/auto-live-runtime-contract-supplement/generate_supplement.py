...
def build() -> dict[str, object]:
    return {
        ...
        "cases": [
            ...
            {
                "case_id": "multiple-connected-component-non-source-order",
                "evidence": ["S11", "S12", "G18"],
                "source_note": {
                    "classification": "method-fixture-with-interleaved-playable-root",
                    "absolute_position": 1424,
                },
                "source_order": [
                    {"slot": 0, "front_note_type": 6, "game_note_type": 10, "button_type": 1},
                    {"slot": 1, "front_note_type": 6, "game_note_type": 10, "button_type": 2},
                    {"slot": 2, "front_note_type": 4, "game_note_type": 5, "button_type": 5},
                    {"slot": 3, "front_note_type": 6, "game_note_type": 10, "button_type": 0},
                ],
                "multiple_candidate_source_order": [1, 2, 0],
                "adjacent_edges": [[0, 1], [1, 2]],
                "connected_components": [[0, 1, 2]],
                "reverse_playable_update_buttons": [0, 5, 2, 1],
                "judged_button": 0,
                "multiple_judgement_count": 1,
                "multiple_directional_flick_note_count": 3,
            },
            {
